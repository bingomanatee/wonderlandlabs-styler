...
describe('StylerStyle', () => {
  ...
  describe('noExtraKeys', () => {
    ...
    it('should be true for exact match', () => {
      expect(ss.noExtraKeys(ATTRS)).toBeTruthy();
    });

    it('should be true for same keys, different props', () => {
      expect(ss.noExtraKeys({
        variant: 'secondary',
        disabled: false,
        appearance: 'light'
      }))
    ...
    it('should be true for fewer keys', () => {
      expect(ss.noExtraKeys({variant: 'secondary',})).toBeTruthy();
    });
  });
  describe('includesKeys', () => {
    const ss = new StylerStyle(STYLE, ATTRS);
    it('should be true for exact match', () => {
      expect(ss.includesKeys(ATTRS)).toBeTruthy();
    });

    it('should be true for same keys, different props', () => {
      expect(ss.includesKeys({
        variant: 'secondary',
        disabled: false,
        appearance: 'light'
      }))
    ...
    it('should be false for fewer keys', () => {
      expect(ss.includesKeys({variant: 'secondary',})).toBeFalsy();
    });
  });
  describe('isLessSpecific', () => {
    ...
    it('should be true for fewer keys', () => {
      expect(ss.isLessSpecific({variant: 'secondary',})).toBeTruthy();
    });
  });
  describe('isLessSpecificMatch', () => {
    ...
    it('should be true for fewer keys', () => {
      ...
      expect(ss.isLessSpecificMatch(sub)).toBeTruthy();
    });
  });
  describe('matches', () => {
    const ss = new StylerStyle(STYLE, ATTRS);
  ...
  describe('specificity', () => {
    ...
    it('should have a specificity of 8 for just appearance', () => {
      const ss = new StylerStyle(STYLE, {appearance: 'foo'});
